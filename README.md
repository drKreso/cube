...
When harnesing OLAP power you are one tiny step away from graphs like this (highcharts.js) on real online systems. Thats why it is worthed to mess with OLAP providers.
